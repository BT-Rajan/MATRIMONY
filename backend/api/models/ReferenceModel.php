...
final class ReferenceModel
{
    ...
    {
        $stmt = Database::connection()->prepare('SELECT * FROM member_references WHERE member_id = :id');
    ...
    public static function upsert(int $memberId, array $fields): void
    {
        ...
        $sql = 'INSERT INTO member_references (' . implode(', ', $columns) . ') VALUES (' . implode(', ', $placeholders) . ')'
